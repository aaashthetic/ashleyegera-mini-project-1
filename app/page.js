...
export default function HomePage() {
  ...
  return (
      <section className="relative w-full min-h-screen overflow-x-hidden pt-20 pb-20">
        {/* LEFT GLOW */}
        ...
        <div className={`relative z-10 flex flex-col items-center px-4 transition-all duration-700 ${hidden ? "opacity-80 -translate-y-10" : "opacity-100 translate-y-0"}`}>
          ...
          <div className="flex flex-col items-center mt-10 md:mt-20 w-full max-w-[1000px]">
            <Badge variant="outline" className="mb-10 border-[#8EB694] text-[#8EB694] px-6 py-1 rounded-full uppercase tracking-widest font-bold">
              Hello World!
            </Badge>
            <div className="relative w-full">
              ...
              <div className="absolute -bottom-6 md:-bottom-12 left-1/2 -translate-x-1/2 w-[80%] max-w-[600px]">
                <img
                  src="/images/role.png"
          ...
          <div className="relative mt-24 md:mt-40 w-full max-w-[1150px] flex justify-center">
            ...
            <div className="relative w-full flex justify-center items-center">
              <img
                ...
                className="w-full max-w-[800px] h-auto object-contain hidden md:block"
              />

              <div className="md:absolute inset-0 flex flex-col items-center justify-center p-6 md:p-12 text-center bg-[#F3E2C6]/80 md:bg-transparent rounded-2xl md:rounded-none shadow-xl md:shadow-none">
                <p className="text-[#8EB694] font-bold font-[Arial] not-[:text-sm] sm:text-base md:text-lg lg:text-base max-w-[700px] leading-relaxed">
